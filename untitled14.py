# -*- coding: utf-8 -*-
"""
Created on Thu May 21 11:07:04 2020
...
X_train, X_test, Y_train, Y_test = train_test_split(X,Y, test_size=0.5, shuffle=True, stratify=target )
xy = (X_train, X_test, Y_train, Y_test)
 
np.save("C:\\Users\\user\\Desktop\\dataset\\img_data(0.5).npy", xy)